...
mysqli_query($mysqli,"INSERT INTO usuario (nombre,apellido,correo,password,idTipoUsr) VALUES ('$nombre', '$apellido', '$correo','$password','2')"); // query qe inserta
$result=mysqli_query($mysqli,"SELECT * FROM usuario");  //este query lo puse para que veas que se pueden hacer varios querys, uno por uno pero asi de simple, recupero los valores que acabo de insertar y los imprimo en consola 
